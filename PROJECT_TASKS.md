...
- [x] Усилить загрузку фото: проверка реального типа файла, лимит размеров, сжатие, удаление EXIF.
- [x] Сократить срок JWT и подготовить refresh-token схему.
...
- [ ] Настроить off-server backup: база и MinIO должны копироваться не только на тот же VPS. Отложено до выбора хранилища.
